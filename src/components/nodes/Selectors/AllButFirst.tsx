...
const AllButFirstComponent: React.FC<PlaylistProps> = React.memo(({ id, data }) => {
  ...
  return (
    <CardWithHeader
      ...
      info="Selects the all but the first element from the input array."
    >
      <NodeHandle
        type="source"
...
export default AllButFirstComponent;
